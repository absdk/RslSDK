...
namespace SoftwareGrid.DataLogic.Seed
{
   public sealed class VendorStatusCategorySeed
    {
        public static List<VendorStatusCategory> VendorStatusCategories
        {
            get
            {
                ...
                items.Add(new VendorStatusCategory { VendorStatusCategoryID = 1, Name = "Approved Vendor" });
                items.Add(new VendorStatusCategory { VendorStatusCategoryID = 2, Name = "Under Review" });
                items.Add(new VendorStatusCategory { VendorStatusCategoryID = 3, Name = "Application Rejected" });
                items.Add(new VendorStatusCategory { VendorStatusCategoryID = 4, Name = "Minority Vendor" });
                items.Add(new VendorStatusCategory { VendorStatusCategoryID = 5, Name = "Master Vendor" });
                items.Add(new VendorStatusCategory { VendorStatusCategoryID = 6, Name = "Preferred Vendor" });
                items.Add(new VendorStatusCategory { VendorStatusCategoryID = 6, Name = "Prime Vendor" });
   ...
   public sealed class VendorNoteCategorySeed
    {
        public static List<VendorNoteCategory> VendorNoteCategories
        {
            get
            {
