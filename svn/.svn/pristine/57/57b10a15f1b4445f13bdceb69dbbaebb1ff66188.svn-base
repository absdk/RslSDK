...
namespace SoftwareGrid.ExceptionLogging
{
    ...
    {
        private CustomExceptionPriority _priority;
    ...
    public class CustomException: ApplicationException
    {
        ...
        string customExceptionUserDefinedMessage = string.Empty;
        string customExceptionSystemMessage = string.Empty;
        ...
        {
            get { return customExceptionSystemMessage; }
        }

        public string UserDefinedMessage
        {
            get { return customExceptionUserDefinedMessage; }
        }
        ...
        public override string Message
        {
            get
            {
                if (base.Message.IsNotNullOrEmpty() && base.Message.Trim()!="Error in the application.")
                {
                    return base.Message;
                }
                else
                {
                    return customExceptionUserDefinedMessage;
                }
            }
        }
        ...
        {
            return "CustomException: " + base.Message + "\n" + base.StackTrace;
        }
            ...
            : base(userAlertSuccessMessage)
        {
            ...
            CustomExceptionDescription exceptionDetail = GetExceptionDetail(ExceptionType);
            ExceptionPriority = exceptionDetail.Priority;
            if (userAlertSuccessMessage.IsNullOrEmpty())
            {
                customExceptionUserDefinedMessage = exceptionDetail.DefaultErrorMessage;
            }
            else
            {
                customExceptionUserDefinedMessage = userAlertSuccessMessage;
            }
            customExceptionSystemMessage = customExceptionUserDefinedMessage;
        } 
