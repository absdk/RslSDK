...
namespace SoftwareGrid.DataLogic.Models
{
  #region Applicant Profile and Detail Resume Builder
    ...
    public class Applicant
    {
        ...
        //for google map api, data will be collected automatically, will be used for distance 
        ...
        //word resume data will be populated into copy paste resume as text, will be indexed also
