...
{ 
    public class AppMenuRepository : IAppMenuRepository
    {
        ...
        public List<MenuViewModel> GetCompanyLandingMenu(int userRoleId)
        {
            return BuildMenu(3, userRoleId);
        }

        public List<MenuViewModel> GetVendorLandingMenu(int userRoleId)
        {
            return BuildMenu(4, userRoleId);
        }

        public List<MenuViewModel> GetOrganizationLandingMenu(int userRoleId)
        {
            return BuildMenu(5, userRoleId);
        }
        ...
        public IQueryable<AppMenu> GetAllParentByAppMenuCategoryID(int appMenuCategoryID)
        {
            return context.AppMenu.Where(menu => menu.AppMenuCategoryID == appMenuCategoryID);
        }
    ...
    public interface IAppMenuRepository
    {
        ...
        List<MenuViewModel> GetCompanyLandingMenu(int userRoleId);
        List<MenuViewModel> GetVendorLandingMenu(int userRoleId);
        List<MenuViewModel> GetOrganizationLandingMenu(int userRoleId);
        IQueryable<AppMenu> GetAllParentByAppMenuCategoryID(int appMenuCategoryID);
