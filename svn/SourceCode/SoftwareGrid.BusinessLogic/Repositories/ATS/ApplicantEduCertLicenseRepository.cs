...
{ 
    public class ApplicantEduCertLicenseRepository : IApplicantEduCertLicenseRepository
    {
        ...
        public IQueryable<ApplicantEduCertLicense> AllIncluding(int applicantId,params Expression<Func<ApplicantEduCertLicense, object>>[] includeProperties)
        {
            IQueryable<ApplicantEduCertLicense> query = context.ApplicantEduCertLicense;
            foreach (var includeProperty in includeProperties) {
                query = query.Include(includeProperty);
            }
            return query.Where(edu=>edu.ApplicantID==applicantId);
        }
    ...
    public interface IApplicantEduCertLicenseRepository
    {
        ...
        IQueryable<ApplicantEduCertLicense> AllIncluding(int applicantId,params Expression<Func<ApplicantEduCertLicense, object>>[] includeProperties);
